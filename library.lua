...
function Library:CreateWindow(WindowInfo)
    ...
    local TopbarRightInset = 40
    local TopbarDragHandleWidth = 30
    ...
    do
        ...
        -- Dedicated drag handle: a separate strip at the far-right edge.
        -- It is intentionally outside the search/buttons area so the move icon
        -- can never sit inside or overlap the search box.
        if MoveIcon then
            local DragHandle = New("TextButton", {
                ...
                Size = UDim2.fromOffset(TopbarDragHandleWidth, 48),
